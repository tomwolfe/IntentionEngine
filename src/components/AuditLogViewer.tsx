            ...
            <div className="p-4 space-y-4">
              {log.plan && (
                <div className="bg-blue-50/50 p-3 rounded border border-blue-100">
                  <p className="text-xs font-bold text-blue-700 uppercase mb-1">Generated Plan</p>
                      ...
                      <div key={idx} className="flex gap-3">
                        ...
                        <div className="flex-1 pb-2">
                          <div className="flex justify-between items-start">
                            <span className="text-sm font-bold text-slate-700">{step.tool_name.replace(/_/g, ' ')}</span>
